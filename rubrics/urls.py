...
urlpatterns = [
    ...
    path('where_to_eat/<slug:slug>',eat_detail,name='eat_detail'),
    path('where_to_go/<slug:slug>',go_detail,name='go_detail'),
    path('where_to_stay/<slug:slug>',stay_detail,name='stay_detail'),
